...
#define BT_MESH_GATT_CFG_OP_ECHO                                             \
	BT_MESH_MODEL_OP_3(0x15, BT_MESH_GATT_CFG_VENDOR_COMPANY_ID)
...
#define BT_MESH_GATT_CFG_MSG_LEN_ECHO 0
#define BT_MESH_GATT_CFG_MSG_LEN_STATUS 1
